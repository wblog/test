...
class ConfigAction extends CommonAction {
	...
	function save(){
		...
		if($file=='siteconfig.inc.php'){	
			...
			if($data['domainname']=='')$data['domainname']=C('HOSTURL');
			if($data['rooturl']=='')$data['rooturl']=C('HOSTURL') ;
			$data['cssurl']=C('ROOTRUL').'Public/Css/' ;
			$data['jsurl']=C('ROOTRUL').'Public/Js/' ;
			$data['imgurl']=C('ROOTRUL').'Public/Images/' ;
